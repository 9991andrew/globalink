<x-data-table :objectClass="$objectClass" :objects="$objects" new>
    ...
    <x-slot name="tableHeadings">
        ...
        <x-datatable.th :sorts="$sorts" field="players_count">Players</x-datatable.th>
        <x-datatable.th :sorts="$sorts" field="map_tile_types_count">Tiles</x-datatable.th>
    </x-slot>
    ...
    @foreach($objects as $object)
        <tr wire:key="row-{{ $object->id }}">
            ...
            <td class="text-center">{{ $object->map_tile_types_count }}</td>
            ...
            <td class="text-center">
                @if($object->map_tile_types_count == 0)
    ...
    <x-slot name="editModal"><livewire:edit-skill /></x-slot>
